...
const currentElement = document.getElementById("current"); // thisssssssssssssssssssssssssssss
...
const setupUI = (user) => {
  if (user) {
    ...
    dbRef.orderByKey().limitToLast(1).on('child_added', snapshot =>{
      ...
      var current = jsonData.current;
      var timedelay = jsonData.timedelay;
      var status = jsonData.status;
      var timestamp = jsonData.timestamp;
      // Update DOM elements
      currentElement.innerHTML = current;
      timedelayElement.innerHTML = timedelay;
